...
{
    public partial class createdDatabaseWithTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CLanguages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Courses_CLanguages_CLanguageId",
                        column: x => x.CLanguageId,
                        principalTable: "CLanguages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "CourseCategories",
                column: "CourseId");
            //her shey duzelmish gorsenir amma menfi nedi bilrsen??? database-n 0di bu deqiqe ichinde hechhhne yoxdu
            //davay indi ichini doldur yoxlayag sen ele chunki men remote qoshulmusham deye donur teaxherdeb bashlayimmm
            //olar
            //amma brnci hobby elave elemelisen sonra tacher
            //di davay b
            migrationBuilder.CreateIndex(
